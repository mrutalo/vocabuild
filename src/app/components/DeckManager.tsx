...
export default function DeckManager({ decks }: DeckManagerProps) {
  ...
  if (selectedDeck) {
    ...
    return (
      <div className="flex">
        {/* Sidebar for PC users */}
        <div className="hidden lg:block">
          <Sidebar
            decks={decks}
            selectedDeck={selectedDeck}
            onDeckSelect={handleDeckSelect}
            onBackToDecks={handleBackToDeckSelection}
            currentPage={currentPage}
            totalPages={Math.ceil(decks.length / decksPerPage)}
        ...
        <div className="flex-1 lg:ml-80">
          ...
          <div className="fixed top-0 left-0 right-0 lg:left-80 bg-white shadow-sm z-10 p-4">
            <div className="max-w-md mx-auto lg:mx-0 flex items-center justify-between">
              <button
